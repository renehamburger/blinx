...
Public Const BX_TRANSLATIONS = "ESV#ESV|English Standard Version#NIV|New International Version#NIB|New International Version (UK)#TNIV|Today's New International Version#NIRV|New International Reader's Version#NASB|New American Standard Bible#KJV|King James Version" & _
                "#NLT|New Living Translation#YLT|Young's Literal Translation#BGT|BW LXX/Greek NT#ELB|Elberfelder#ZUR|Z�rcher#SCL|Schlachter 2000#EIN|Einheits�bersetzung#LUO|Luther 1912#NEU|Neue evangelistische �bersetzung"  'WTT|BW Hebrew OT# leads to crash...
...
Public Const BX_DEFAULT_BOOK_NAMES_DE = _
                ...
                "#Josua|Jos#Richter|Rich|Ri#Rut|Ru#1 Samuel|1 Sam|1 Sa#2 Samuel|2 Sam|2 Sa#1 K�nige|1 K�n|1 Kng|1 K�#2 K�nige|2 K�n|2 Kng|2 K�#1 Chronik|1 Chron|1 Chr#2 Chronik|2 Chron|2 Chr" & _
                "#Esra|Esr#Nehemia|Neh#Ester|Est#Hiob|Ijob|Job#Psalmen|Psalm|Pslm|Ps#Spr�che|Sprichw�rter|Spr#Prediger|Pred|Kohelet|Koh|Ecclesiastes#Hohelied|Hoheslied|Hld#Jesaja|Jes#Jeremia|Jer#Klagelieder|Klgl" & _
                ...
                "#Matth�us|Matt|Mt#Markus|Mark|Mk#Lukas|Luk|Lk#Johannes|Joh#Apostelgeschichte|Apg#R�mer|R�m|Rm#1 Korinther|1 Kor|1 Ko#2 Korinther|2 Kor|2 Ko#Galater|Gal" & _
                ...
                "#Philemon|Phlm|Phm#Hebr�er|Hebr|Heb|Hb#Jakobus|Jak|Jk#1 Petrus|1 Petr|1 Pet|1 Pt#2 Petrus|2 Petr|2 Pet|2 Pt" & _
      ...
      Select Case bx_eLanguage
        ...
        Case BX_GERMAN
          bEqual = ((AscW(sChar) >= AscW("a") And AscW(sChar) <= AscW("z")) Or (AscW(sChar) >= AscW("A") And AscW(sChar) <= AscW("Z"))) _
                    Or (AscW(sChar) = AscW("�")) Or (AscW(sChar) = AscW("�")) Or (AscW(sChar) = AscW("�")) Or (AscW(sChar) = AscW("�")) Or (AscW(sChar) = AscW("�")) Or (AscW(sChar) = AscW("�")) Or (AscW(sChar) = AscW("�"))
        Case Default 'other
          bEqual = ((AscW(sChar) >= AscW("a") And AscW(sChar) <= AscW("z")) Or (AscW(sChar) >= AscW("A") And AscW(sChar) <= AscW("Z")))
      End Select
    End If
